...
import static com.bestproject.main.StaticBuffer.effectBuffer;
...
import com.bestproject.main.MapUtils.WeatherAreaTest;
...
public class Village extends Map{
    ...
    public Village(){
        ...
        depthBuffer=new FrameBuffer(Pixmap.Format.RGBA8888
            ...
            , true);
        weatherArea=new WeatherAreaTest(StaticBuffer.assetManager);
    ...
    public void MapInitialization(){
        ...
        directionalLightEx.color.set(
            Color.valueOf("FFA500").lerp(Color.BLACK,0.5f)
        );
    }
    ...
    public void gridinit(){
        ...
        for (int row = 0; row < rows; row++) {
            ...
            for (int col = 0; col < columns; col++) {
                ...
                Tiles.get(row).add(new ConcreteTile(new Vector3(col*2,0,row*2)));
            }
        }
    }
